...
data0 = sio.loadmat(r'/Users/renxiaoxu/NutstoreCloudBridge/我的坚果云/要备份！！！！！/撰写论文/1115-Info/info2023/Lyp+AC+2_3_queue/factor_compare/constrain/pic/result_con_energy_SLA.mat')
...
plt.savefig('data_3D_SLA_time.pdf', dpi=600)
...
Z_H=matrix0_H.reshape(10,20)
print(Z_H)
surface = ax2.plot_surface(X,Y,Z_H, cmap=plt.cm.viridis,  antialiased=False)
fig.colorbar(surface)
plt.savefig(r'/Users/renxiaoxu/NutstoreCloudBridge/我的坚果云/要备份！！！！！/撰写论文/1115-Info/info2023/Lyp+AC+2_3_queue/factor_compare/time_3D_SLA_time.pdf', dpi=600)
...
Z_Y=matrix0_Y.reshape(10,20)
print(Z_Y)


surface = ax3.plot_surface(X,Y,Z_Y,cmap=plt.cm.viridis,  antialiased=False)
fig.colorbar(surface)
plt.savefig(r'/Users/renxiaoxu/NutstoreCloudBridge/我的坚果云/要备份！！！！！/撰写论文/1115-Info/info2023/Lyp+AC+2_3_queue/factor_compare/energy_3D_SLA_time.pdf', dpi=600)
