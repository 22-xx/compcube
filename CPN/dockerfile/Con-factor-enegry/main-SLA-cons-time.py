...
from A2SC_constrain_time import A2SC
...
for i in range(len(SLA_time)):
    for j in range(len(P_t)):
        print(i,j)
        price_1,Q_1,H_1,Y_1=A2SC(n,SLA_time[i],P_t[j])
...
sio.savemat(r'/Users/renxiaoxu/NutstoreCloudBridge/我的坚果云/要备份！！！！！/撰写论文/1115-Info/info2023/Lyp+AC+2_3_queue/factor_compare/constrain/pic/result_constrain_SLA.mat', {'price': price_1, 'data_queue': Q_1_total, 'time_queue': H_1_total, 'energy_queue': Y_1_total})
